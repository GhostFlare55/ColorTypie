...
time.sleep(3)
print("You'll have 1 min to type the colors displayed on screen")
time.sleep(5)
...
colors = ['red', 'blue', 'green', 'yellow', 'orange', 'purple', 'brown','white','black','turquoise','grey','magenta','cyan','pink']
